...
const projects: Project[] = [
  ...
  },
  {
    name: "EasterEgg PoC",
    description:
      "Ein kleines Proof of Concept (PoC) für ein Easter Egg auf einer Website. Dieses Projekt war ein Mockup, um eine versteckte Funktion auszulösen, wenn der Benutzer eine bestimmte Tastenkombination eingibt.",
    tech: "Angular, TypeScript, HTML/CSS",
