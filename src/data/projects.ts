...
export const projects: Project[] = [
  ...
  },
  {
    ...
    descriptionEn:
      "An Angular playground – a development and learning environment where I experimented with Angular on small example pages and concepts. This repository serves as a sandbox for Angular ideas, component tests and early implementations without a fixed product focus.",
