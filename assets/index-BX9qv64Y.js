...
`)+`
`+x);const U=O+M+d,C=O+x+h,I=Sv(l,l.VERTEX_SHADER,U),z=Sv(l,l.FRAGMENT_SHADER,C);l.attachShader(T,I),l.attachShader(T,z),i.index0AttributeName!==void 0?l.bindAttribLocation(T,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(T,0,"position"),l.linkProgram(T);function B(H){if(r.debug.checkShaderErrors){const K=l.getProgramInfoLog(T)||"",ie=l.getShaderInfoLog(I)||"",de=l.getShaderInfoLog(z)||"",ue=K.trim(),L=ie.trim(),G=de.trim();let J=!0,ve=!0;if(l.getProgramParameter(T,l.LINK_STATUS)===!1)if(J=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,T,I,z);else{const ye=Mv(l,I,"vertex"),P=Mv(l,z,"fragment");Rt("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(T,l.VALIDATE_STATUS)+`
