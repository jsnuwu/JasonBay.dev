...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xa,depthTest:!1,depthWrite:!1})}function F1(r,e,i){const s=new Float32Array(Os),l=new ae(0,1,0);return new Yi({name:"SphericalGaussianBlur",defines:{n:Os,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:xu(),fragmentShader:`
	...
	`}function z1(r){let e=new WeakMap,i=null;function s(h){if(h&&h.isTexture){const m=h.mapping,p=m===Th||m===Ah,g=m===Bs||m===kr;if(p||g){let _=e.get(h);const v=_!==void 0?_.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==v)return i===null&&(i=new uv(r)),_=p?i.fromEquirectangular(h,_):i.fromCubemap(h,_),_.texture.pmremVersion=h.pmremVersion,e.set(h,_),_.texture;if(_!==void 0)return _.texture;{const y=h.image;return p&&y&&y.height>0||g&&y&&l(y)?(i===null&&(i=new uv(r)),_=p?i.fromEquirectangular(h):i.fromCubemap(h),_.texture.pmremVersion=h.pmremVersion,e.set(h,_),h.addEventListener("dispose",c),_.texture):null}}}return h}function l(h){let m=0;const p=6;for(let g=0;g<p;g++)h[g]!==void 0&&m++;return m===p}function c(h){const m=h.target;m.removeEventListener("dispose",c);const p=e.get(m);p!==void 0&&(e.delete(m),p.dispose())}function d(){e=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:d}}function H1(r){const e={};function i(s){if(e[s]!==void 0)return e[s];const l=r.getExtension(s);return e[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&ll("WebGLRenderer: "+s+" extension not supported."),l}}}function G1(r,e,i,s){const l={},c=new WeakMap;function d(_){const v=_.target;v.index!==null&&e.remove(v.index);for(const E in v.attributes)e.remove(v.attributes[E]);v.removeEventListener("dispose",d),delete l[v.id];const y=c.get(v);y&&(e.remove(y),c.delete(v)),s.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,i.memory.geometries--}function h(_,v){return l[v.id]===!0||(v.addEventListener("dispose",d),l[v.id]=!0,i.memory.geometries++),v}function m(_){const v=_.attributes;for(const y in v)e.update(v[y],r.ARRAY_BUFFER)}function p(_){const v=[],y=_.index,E=_.attributes.position;let T=0;if(y!==null){const U=y.array;T=y.version;for(let O=0,C=U.length;O<C;O+=3){const I=U[O+0],z=U[O+1],B=U[O+2];v.push(I,z,z,B,B,I)}}else if(E!==void 0){const U=E.array;T=E.version;for(let O=0,C=U.length/3-1;O<C;O+=3){const I=O+0,z=O+1,B=O+2;v.push(I,z,z,B,B,I)}}else return;const M=new(ux(v)?mx:px)(v,1);M.version=T;const x=c.get(_);x&&e.remove(x),c.set(_,M)}function g(_){const v=c.get(_);if(v){const y=_.index;y!==null&&v.version<y.version&&p(_)}else p(_);return c.get(_)}return{get:h,update:m,getWireframeAttribute:g}}function V1(r,e,i){let s;function l(v){s=v}let c,d;function h(v){c=v.type,d=v.bytesPerElement}function m(v,y){r.drawElements(s,y,c,v*d),i.update(y,s,1)}function p(v,y,E){E!==0&&(r.drawElementsInstanced(s,y,c,v*d,E),i.update(y,s,E))}function g(v,y,E){if(E===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,y,0,c,v,0,E);let M=0;for(let x=0;x<E;x++)M+=y[x];i.update(M,s,1)}function _(v,y,E,T){if(E===0)return;const M=e.get("WEBGL_multi_draw");if(M===null)for(let x=0;x<v.length;x++)p(v[x]/d,y[x],T[x]);else{M.multiDrawElementsInstancedWEBGL(s,y,0,c,v,0,T,0,E);let x=0;for(let U=0;U<E;U++)x+=y[U]*T[U];i.update(x,s,1)}}this.setMode=l,this.setIndex=h,this.render=m,this.renderInstances=p,this.renderMultiDraw=g,this.renderMultiDrawInstances=_}function k1(r){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,d,h){switch(i.calls++,d){case r.TRIANGLES:i.triangles+=h*(c/3);break;case r.LINES:i.lines+=h*(c/2);break;case r.LINE_STRIP:i.lines+=h*(c-1);break;case r.LINE_LOOP:i.lines+=h*c;break;case r.POINTS:i.points+=h*c;break;default:Rt("WebGLInfo: Unknown draw mode:",d);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:s}}function X1(r,e,i){const s=new WeakMap,l=new on;function c(d,h,m){const p=d.morphTargetInfluences,g=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,_=g!==void 0?g.length:0;let v=s.get(h);if(v===void 0||v.count!==_){let D=function(){K.dispose(),s.delete(h),h.removeEventListener("dispose",D)};var y=D;v!==void 0&&v.texture.dispose();const E=h.morphAttributes.position!==void 0,T=h.morphAttributes.normal!==void 0,M=h.morphAttributes.color!==void 0,x=h.morphAttributes.position||[],U=h.morphAttributes.normal||[],O=h.morphAttributes.color||[];let C=0;E===!0&&(C=1),T===!0&&(C=2),M===!0&&(C=3);let I=h.attributes.position.count*C,z=1;I>e.maxTextureSize&&(z=Math.ceil(I/e.maxTextureSize),I=e.maxTextureSize);const B=new Float32Array(I*z*4*_),K=new fx(B,I,z,_);K.type=Vi,K.needsUpdate=!0;const w=C*4;for(let H=0;H<_;H++){const Z=x[H],ie=U[H],de=O[H],ue=I*z*4*H;for(let L=0;L<Z.count;L++){const G=L*w;E===!0&&(l.fromBufferAttribute(Z,L),B[ue+G+0]=l.x,B[ue+G+1]=l.y,B[ue+G+2]=l.z,B[ue+G+3]=0),T===!0&&(l.fromBufferAttribute(ie,L),B[ue+G+4]=l.x,B[ue+G+5]=l.y,B[ue+G+6]=l.z,B[ue+G+7]=0),M===!0&&(l.fromBufferAttribute(de,L),B[ue+G+8]=l.x,B[ue+G+9]=l.y,B[ue+G+10]=l.z,B[ue+G+11]=de.itemSize===4?l.w:1)}}v={count:_,texture:K,size:new Ht(I,z)},s.set(h,v),h.addEventListener("dispose",D)}if(d.isInstancedMesh===!0&&d.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",d.morphTexture,i);else{let E=0;for(let M=0;M<p.length;M++)E+=p[M];const T=h.morphTargetsRelative?1:1-E;m.getUniforms().setValue(r,"morphTargetBaseInfluence",T),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",v.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",v.size)}return{update:c}}function j1(r,e,i,s){let l=new WeakMap;function c(m){const p=s.render.frame,g=m.geometry,_=e.get(m,g);if(l.get(_)!==p&&(e.update(_),l.set(_,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",h)===!1&&m.addEventListener("dispose",h),l.get(m)!==p&&(i.update(m.instanceMatrix,r.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,r.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const v=m.skeleton;l.get(v)!==p&&(v.update(),l.set(v,p))}return _}function d(){l=new WeakMap}function h(m){const p=m.target;p.removeEventListener("dispose",h),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:c,dispose:d}}const W1={[Kv]:"LINEAR_TONE_MAPPING",[Zv]:"REINHARD_TONE_MAPPING",[Jv]:"CINEON_TONE_MAPPING",[Qv]:"ACES_FILMIC_TONE_MAPPING",[ex]:"AGX_TONE_MAPPING",[tx]:"NEUTRAL_TONE_MAPPING",[$v]:"CUSTOM_TONE_MAPPING"};function Y1(r,e,i,s,l){const c=new ji(e,i,{type:r,depthBuffer:s,stencilBuffer:l}),d=new ji(e,i,{type:ya,depthBuffer:!1,stencilBuffer:!1}),h=new In;h.setAttribute("position",new Jn([-1,3,0,-1,-1,0,3,-1,0],3)),h.setAttribute("uv",new Jn([0,2,0,0,2,0],2));const m=new Hb({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),p=new ba(h,m),g=new Ex(-1,1,1,-1,0,1);let _=null,v=null,y=!1,E,T=null,M=[],x=!1;this.setSize=function(U,O){c.setSize(U,O),d.setSize(U,O);for(let C=0;C<M.length;C++){const I=M[C];I.setSize&&I.setSize(U,O)}},this.setEffects=function(U){M=U,x=M.length>0&&M[0].isRenderPass===!0;const O=c.width,C=c.height;for(let I=0;I<M.length;I++){const z=M[I];z.setSize&&z.setSize(O,C)}},this.begin=function(U,O){if(y||U.toneMapping===Xi&&M.length===0)return!1;if(T=O,O!==null){const C=O.width,I=O.height;(c.width!==C||c.height!==I)&&this.setSize(C,I)}return x===!1&&U.setRenderTarget(c),E=U.toneMapping,U.toneMapping=Xi,!0},this.hasRenderPass=function(){return x},this.end=function(U,O){U.toneMapping=E,y=!0;let C=c,I=d;for(let z=0;z<M.length;z++){const B=M[z];if(B.enabled!==!1&&(B.render(U,I,C,O),B.needsSwap!==!1)){const K=C;C=I,I=K}}if(_!==U.outputColorSpace||v!==U.toneMapping){_=U.outputColorSpace,v=U.toneMapping,m.defines={},wt.getTransfer(_)===zt&&(m.defines.SRGB_TRANSFER="");const z=W1[v];z&&(m.defines[z]=""),m.needsUpdate=!0}m.uniforms.tDiffuse.value=C.texture,U.setRenderTarget(T),U.render(p,g),T=null,y=!1},this.isCompositing=function(){return y},this.dispose=function(){c.dispose(),d.dispose(),h.dispose(),m.dispose()}}const Tx=new Vn,up=new ul(1,1),Ax=new fx,Rx=new gb,wx=new vx,pv=[],mv=[],gv=new Float32Array(16),_v=new Float32Array(9),vv=new Float32Array(4);function Zr(r,e,i){const s=r[0];if(s<=0||s>0)return r;const l=e*i;let c=pv[l];if(c===void 0&&(c=new Float32Array(l),pv[l]=c),e!==0){s.toArray(c,0);for(let d=1,h=0;d!==e;++d)h+=i,r[d].toArray(c,h)}return c}function _n(r,e){if(r.length!==e.length)return!1;for(let i=0,s=r.length;i<s;i++)if(r[i]!==e[i])return!1;return!0}function vn(r,e){for(let i=0,s=e.length;i<s;i++)r[i]=e[i]}function Su(r,e){let i=mv[e];i===void 0&&(i=new Int32Array(e),mv[e]=i);for(let s=0;s!==e;++s)i[s]=r.allocateTextureUnit();return i}function q1(r,e){const i=this.cache;i[0]!==e&&(r.uniform1f(this.addr,e),i[0]=e)}function K1(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(_n(i,e))return;r.uniform2fv(this.addr,e),vn(i,e)}}function Z1(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else if(e.r!==void 0)(i[0]!==e.r||i[1]!==e.g||i[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),i[0]=e.r,i[1]=e.g,i[2]=e.b);else{if(_n(i,e))return;r.uniform3fv(this.addr,e),vn(i,e)}}function J1(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(_n(i,e))return;r.uniform4fv(this.addr,e),vn(i,e)}}function Q1(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(_n(i,e))return;r.uniformMatrix2fv(this.addr,!1,e),vn(i,e)}else{if(_n(i,s))return;vv.set(s),r.uniformMatrix2fv(this.addr,!1,vv),vn(i,s)}}function $1(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(_n(i,e))return;r.uniformMatrix3fv(this.addr,!1,e),vn(i,e)}else{if(_n(i,s))return;_v.set(s),r.uniformMatrix3fv(this.addr,!1,_v),vn(i,s)}}function eR(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(_n(i,e))return;r.uniformMatrix4fv(this.addr,!1,e),vn(i,e)}else{if(_n(i,s))return;gv.set(s),r.uniformMatrix4fv(this.addr,!1,gv),vn(i,s)}}function tR(r,e){const i=this.cache;i[0]!==e&&(r.uniform1i(this.addr,e),i[0]=e)}function nR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(_n(i,e))return;r.uniform2iv(this.addr,e),vn(i,e)}}function iR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(_n(i,e))return;r.uniform3iv(this.addr,e),vn(i,e)}}function aR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(_n(i,e))return;r.uniform4iv(this.addr,e),vn(i,e)}}function sR(r,e){const i=this.cache;i[0]!==e&&(r.uniform1ui(this.addr,e),i[0]=e)}function rR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(_n(i,e))return;r.uniform2uiv(this.addr,e),vn(i,e)}}function oR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(_n(i,e))return;r.uniform3uiv(this.addr,e),vn(i,e)}}function lR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(_n(i,e))return;r.uniform4uiv(this.addr,e),vn(i,e)}}function cR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l);let c;this.type===r.SAMPLER_2D_SHADOW?(up.compareFunction=i.isReversedDepthBuffer()?Mp:yp,c=up):c=Tx,i.setTexture2D(e||c,l)}function uR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture3D(e||Rx,l)}function fR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTextureCube(e||wx,l)}function dR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture2DArray(e||Ax,l)}function hR(r){switch(r){case 5126:return q1;case 35664:return K1;case 35665:return Z1;case 35666:return J1;case 35674:return Q1;case 35675:return $1;case 35676:return eR;case 5124:case 35670:return tR;case 35667:case 35671:return nR;case 35668:case 35672:return iR;case 35669:case 35673:return aR;case 5125:return sR;case 36294:return rR;case 36295:return oR;case 36296:return lR;case 35678:case 36198:case 36298:case 36306:case 35682:return cR;case 35679:case 36299:case 36307:return uR;case 35680:case 36300:case 36308:case 36293:return fR;case 36289:case 36303:case 36311:case 36292:return dR}}function pR(r,e){r.uniform1fv(this.addr,e)}function mR(r,e){const i=Zr(e,this.size,2);r.uniform2fv(this.addr,i)}function gR(r,e){const i=Zr(e,this.size,3);r.uniform3fv(this.addr,i)}function _R(r,e){const i=Zr(e,this.size,4);r.uniform4fv(this.addr,i)}function vR(r,e){const i=Zr(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,i)}function xR(r,e){const i=Zr(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,i)}function SR(r,e){const i=Zr(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,i)}function yR(r,e){r.uniform1iv(this.addr,e)}function MR(r,e){r.uniform2iv(this.addr,e)}function ER(r,e){r.uniform3iv(this.addr,e)}function bR(r,e){r.uniform4iv(this.addr,e)}function TR(r,e){r.uniform1uiv(this.addr,e)}function AR(r,e){r.uniform2uiv(this.addr,e)}function RR(r,e){r.uniform3uiv(this.addr,e)}function wR(r,e){r.uniform4uiv(this.addr,e)}function CR(r,e,i){const s=this.cache,l=e.length,c=Su(i,l);_n(s,c)||(r.uniform1iv(this.addr,c),vn(s,c));let d;this.type===r.SAMPLER_2D_SHADOW?d=up:d=Tx;for(let h=0;h!==l;++h)i.setTexture2D(e[h]||d,c[h])}function DR(r,e,i){const s=this.cache,l=e.length,c=Su(i,l);_n(s,c)||(r.uniform1iv(this.addr,c),vn(s,c));for(let d=0;d!==l;++d)i.setTexture3D(e[d]||Rx,c[d])}function LR(r,e,i){const s=this.cache,l=e.length,c=Su(i,l);_n(s,c)||(r.uniform1iv(this.addr,c),vn(s,c));for(let d=0;d!==l;++d)i.setTextureCube(e[d]||wx,c[d])}function NR(r,e,i){const s=this.cache,l=e.length,c=Su(i,l);_n(s,c)||(r.uniform1iv(this.addr,c),vn(s,c));for(let d=0;d!==l;++d)i.setTexture2DArray(e[d]||Ax,c[d])}function UR(r){switch(r){case 5126:return pR;case 35664:return mR;case 35665:return gR;case 35666:return _R;case 35674:return vR;case 35675:return xR;case 35676:return SR;case 5124:case 35670:return yR;case 35667:case 35671:return MR;case 35668:case 35672:return ER;case 35669:case 35673:return bR;case 5125:return TR;case 36294:return AR;case 36295:return RR;case 36296:return wR;case 35678:case 36198:case 36298:case 36306:case 35682:return CR;case 35679:case 36299:case 36307:return DR;case 35680:case 36300:case 36308:case 36293:return LR;case 36289:case 36303:case 36311:case 36292:return NR}}class OR{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.setValue=hR(i.type)}}class PR{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=UR(i.type)}}class IR{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,i,s){const l=this.seq;for(let c=0,d=l.length;c!==d;++c){const h=l[c];h.setValue(e,i[h.id],s)}}}const ch=/(\w+)(\])?(\[|\.)?/g;function xv(r,e){r.seq.push(e),r.map[e.id]=e}function BR(r,e,i){const s=r.name,l=s.length;for(ch.lastIndex=0;;){const c=ch.exec(s),d=ch.lastIndex;let h=c[1];const m=c[2]==="]",p=c[3];if(m&&(h=h|0),p===void 0||p==="["&&d+2===l){xv(i,p===void 0?new OR(h,r,e):new PR(h,r,e));break}else{let _=i.map[h];_===void 0&&(_=new IR(h),xv(i,_)),i=_}}}class ou{constructor(e,i){this.seq=[],this.map={};const s=e.getProgramParameter(i,e.ACTIVE_UNIFORMS);for(let d=0;d<s;++d){const h=e.getActiveUniform(i,d),m=e.getUniformLocation(i,h.name);BR(h,m,this)}const l=[],c=[];for(const d of this.seq)d.type===e.SAMPLER_2D_SHADOW||d.type===e.SAMPLER_CUBE_SHADOW||d.type===e.SAMPLER_2D_ARRAY_SHADOW?l.push(d):c.push(d);l.length>0&&(this.seq=l.concat(c))}setValue(e,i,s,l){const c=this.map[i];c!==void 0&&c.setValue(e,s,l)}setOptional(e,i,s){const l=i[s];l!==void 0&&this.setValue(e,s,l)}static upload(e,i,s,l){for(let c=0,d=i.length;c!==d;++c){const h=i[c],m=s[h.id];m.needsUpdate!==!1&&h.setValue(e,m.value,l)}}static seqWithValue(e,i){const s=[];for(let l=0,c=e.length;l!==c;++l){const d=e[l];d.id in i&&s.push(d)}return s}}function Sv(r,e,i){const s=r.createShader(e);return r.shaderSource(s,i),r.compileShader(s),s}const FR=37297;let zR=0;function HR(r,e){const i=r.split(`
`),s=[],l=Math.max(e-6,0),c=Math.min(e+6,i.length);for(let d=l;d<c;d++){const h=d+1;s.push(`${h===e?">":" "} ${h}: ${i[d]}`)}return s.join(`
`)}const yv=new ht;function GR(r){wt._getMatrix(yv,wt.workingColorSpace,r);const e=`mat3( ${yv.elements.map(i=>i.toFixed(4))} )`;switch(wt.getTransfer(r)){case cu:return[e,"LinearTransferOETF"];case zt:return[e,"sRGBTransferOETF"];default:return at("WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function Mv(r,e,i){const s=r.getShaderParameter(e,r.COMPILE_STATUS),c=(r.getShaderInfoLog(e)||"").trim();if(s&&c==="")return"";const d=/ERROR: 0:(\d+)/.exec(c);if(d){const h=parseInt(d[1]);return i.toUpperCase()+`

`+c+`

`+HR(r.getShaderSource(e),h)}else return c}function VR(r,e){const i=GR(e);return[`vec4 ${r}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}const kR={[Kv]:"Linear",[Zv]:"Reinhard",[Jv]:"Cineon",[Qv]:"ACESFilmic",[ex]:"AgX",[tx]:"Neutral",[$v]:"Custom"};function XR(r,e){const i=kR[e];return i===void 0?(at("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Jc=new ae;function jR(){wt.getLuminanceCoefficients(Jc);const r=Jc.x.toFixed(4),e=Jc.y.toFixed(4),i=Jc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function WR(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(nl).join(`
`)}function YR(r){const e=[];for(const i in r){const s=r[i];s!==!1&&e.push("#define "+i+" "+s)}return e.join(`
`)}function qR(r,e){const i={},s=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let l=0;l<s;l++){const c=r.getActiveAttrib(e,l),d=c.name;let h=1;c.type===r.FLOAT_MAT2&&(h=2),c.type===r.FLOAT_MAT3&&(h=3),c.type===r.FLOAT_MAT4&&(h=4),i[d]={type:c.type,location:r.getAttribLocation(e,d),locationSize:h}}return i}function nl(r){return r!==""}function Ev(r,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function bv(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const KR=/^[ \t]*#include +<([\w\d./]+)>/gm;function fp(r){return r.replace(KR,JR)}const ZR=new Map;function JR(r,e){let i=pt[e];if(i===void 0){const s=ZR.get(e);if(s!==void 0)i=pt[s],at('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,s);else throw new Error("Can not resolve #include <"+e+">")}return fp(i)}const QR=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Tv(r){return r.replace(QR,$R)}function $R(r,e,i,s){let l="";for(let c=parseInt(e);c<parseInt(i);c++)l+=s.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function Av(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}const ew={[tu]:"SHADOWMAP_TYPE_PCF",[tl]:"SHADOWMAP_TYPE_VSM"};function tw(r){return ew[r.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const nw={[Bs]:"ENVMAP_TYPE_CUBE",[kr]:"ENVMAP_TYPE_CUBE",[gu]:"ENVMAP_TYPE_CUBE_UV"};function iw(r){return r.envMap===!1?"ENVMAP_TYPE_CUBE":nw[r.envMapMode]||"ENVMAP_TYPE_CUBE"}const aw={[kr]:"ENVMAP_MODE_REFRACTION"};function sw(r){return r.envMap===!1?"ENVMAP_MODE_REFLECTION":aw[r.envMapMode]||"ENVMAP_MODE_REFLECTION"}const rw={[qv]:"ENVMAP_BLENDING_MULTIPLY",[PE]:"ENVMAP_BLENDING_MIX",[IE]:"ENVMAP_BLENDING_ADD"};function ow(r){return r.envMap===!1?"ENVMAP_BLENDING_NONE":rw[r.combine]||"ENVMAP_BLENDING_NONE"}function lw(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,s=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:s,maxMip:i}}function cw(r,e,i,s){const l=r.getContext(),c=i.defines;let d=i.vertexShader,h=i.fragmentShader;const m=tw(i),p=iw(i),g=sw(i),_=ow(i),v=lw(i),y=WR(i),E=YR(c),T=l.createProgram();let M,x,U=i.glslVersion?"#version "+i.glslVersion+`
